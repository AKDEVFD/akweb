      ...
      <div className="px-16 md:px-24 lg:px-40">
        <div className="flex flex-col gap-3">
          {images.map((img) => (
            <div
              key={img.sha}
              className="group relative bg-red-600s w-full flex items-center justify-center py-6"
            >
              <img
              ...
              />
              <div className="absolute inset-0 bg-red-600/0 group-hover:bg-black/50 transition-colors duration-300 flex items-end">
